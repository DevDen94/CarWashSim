...
{
    public static PaintTarget Instance;
    ...
    public static Color CursorColor()
    {
        ...
        //Ray ray = Gun.Instance.hitInfo;
        return RayColor(Gun.Instance.hitInfo);
    }
    ...
    public static int CursorChannel()
    {
        ...
        //RaycastHit ray = Gun.Instance.hitInfo;
        return RayChannel(Gun.Instance.hitInfo);
